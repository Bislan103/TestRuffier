...
txt_test2 = 'Выполните 30 приседаний за 45 секунд. Для этого нажмите кнопку \
 "Начать делать приседания",\nчтобы запустить счетчик приседаний.'
txt_test3 = 'Лягте на спину и замерьте пульс сначала за первые 15 секунд \
 минуты, затем за последние 15 секунд.\nНажмите кнопку "Начать финальный тест",\
  чтобы запустить таймер.\nЗеленым обозначены секунды, \
   в течение которых необходимо \nпроводить измерения, \
    черным - минуты без замера пульсаций. Результаты запишите \
